...
(function() {
  ...
  require.register('marked', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'marked/')); }), {});
    /**
...
var _iboard = require("web/static/js/iboard");
...
var App = exports.App = {
  run: function run() {
    _iboard.Iboard.iboard();
  }
};
});

;require.register("web/static/js/iboard", function(exports, require, module) {
var Iboard;

Iboard = {
  iboard: function() {
    var markdownElements;
    markdownElements = document.getElementsByClassName("markdown");
    return this.doMarkdown(markdownElements);
  },
  doMarkdown: function(elements) {
    var element, i, len, markdown, md, options, results;
    md = require('marked');
    options = {
      gfm: true,
      tables: true,
    ...
    for (i = 0, len = elements.length; i < len; i++) {
      ...
      results.push(element.innerHTML = markdown);
    }
    return results;
  }
};
